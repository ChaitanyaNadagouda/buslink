...
- When the active sprint is completed:
  ...
  4. Ask me to prepare the next sprint plan in Notion.
  5. After I approve the next sprint plan, generate the next sprint file (for example, docs/sprints/Sprint-02.md).
  6. Update this roadmap with the new active sprint.
